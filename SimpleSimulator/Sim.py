...
def func_ld(inputline):
    ...
    output_list[R1]=int(input_list[mem],2)
    output_list[8]=0 #reseting FLAGS register to 0
...
def func_rs(inputline):
    ...
    num = num >> imm
    output_list[R1] = num
    output_list[8] = 0  # resetting FLAGS register to 0
...
def func_cmp(inputline):
    ...
    if num1<num2:
        ...
        # print("ddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddadadjasdc asjdc ")
        output_list[8]=1 
    ...
    if line !=0:
        ...
        for i in range(9):
            if i==0:
                ...
                # print([i for i in output_list if type(i)==float])
                # print(output_list)
                print(str(bin(output_list[i]))[2:].zfill(16), end=" ")
        output_list[0]=int(pc)
for i in input_list:
